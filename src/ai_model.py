...
class AIModel:
    ...
    def create_target_labels(self, df: pd.DataFrame) -> pd.Series:
        ...
        This function creates binary labels indicating whether the price will go up or down
        ...
        try:
            ...
            # Remove NaN values from the end (where future price is unknown)
    ...
    def train_model(self, product_id: str, test_size: float = 0.2) -> Dict[str, Any]:
        """
    ...
    def get_model_status(self) -> Dict[str, Any]:
        ...
        # Helper function to get model-specific info
        def get_model_info(product_id: str, model_prefix: str) -> Dict[str, Any]:
            """Get model info for template display."""
            is_ready = product_id in models_trained or product_id in models_on_disk
        ...
        alt_ready = any(product in models_trained or product in models_on_disk for product in alt_products)
